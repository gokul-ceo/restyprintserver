        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    printer.alignLeft();
                    printer.tableCustom([
                        { text: "Order ID: ".concat(data.orderid), align: 'LEFT', width: 0.5 },
                        { text: "Date: ".concat(data.date), align: 'RIGHT', width: 0.5 },
                        { text: "Time: ".concat(data.time), align: 'LEFT', width: 0.5 }
                    ]);
                    printer.drawLine();
                    printer.alignLeft();
                    printer.tableCustom([
                    ...
                    printer.drawLine();
                    data.orderdetails.forEach(function (orderItem) {
                        printer.tableCustom([
                    ...
                    printer.alignRight();
                    printer.bold(true);
                    printer.println("Total: ".concat(data.total));
                    printer.bold(false);
                    printer.alignCenter();
                    printer.drawLine();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.log('Print failed:', error_1);
                    return [3 /*break*/, 4];
                case 3:
                    printer.clear();
                    return [7 /*endfinally*/];
